...
- `mcoordinator <repo> --worker <session>` bootstraps the default autonomous tmux coordinator; `mcoordinator --all` handles multi-repo scope without requiring iTerm2 or the router.
